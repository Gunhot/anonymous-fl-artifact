...
class Server:
        ...
        with torch.no_grad():
            for name, param in proxy_sd.items():
                ...
                if w > 0:
                    ...
                    # -------------------------------------------------------
                    block_size = 256
                    flat_param = original_param.flatten()  # LPP uses original params without masking.
    ...
    def get_model(self, round_idx=None, client_id=None, centered_noise=None, force_proxy=False):
