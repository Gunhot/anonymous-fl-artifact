...
def resnet18(num_class, model_rate=1, track=True, scale=True):
...
def resnet101(num_class, model_rate=1, track=True, scale=True):
    ...
    return Multi_ResNet(hidden_size, BottleneckBlock, [3,4,23,3], num_classes=classes_size, scaler_rate=scaler_rate, track=track, scale=scale)
