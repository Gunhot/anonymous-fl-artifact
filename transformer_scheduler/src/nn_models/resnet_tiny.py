...
class Multi_ResNet(nn.Module):
    ...
    def __init__(self, block, layers, n_blocks, num_classes=1000, \
        ...
        self.middle_fc1 = nn.Linear(512, num_classes)
        ...
        if n_blocks > 1:
            ...
            self.middle_fc2 = nn.Linear(512, num_classes)
        ...
        if n_blocks > 2:
            ...
            self.middle_fc3 = nn.Linear(512, num_classes)
...
def multi_resnet18_tiny(n_blocks=4, num_classes=200, norm='bn'):
    if norm == 'gn':
...
def multi_resnet34_tiny(n_blocks=4, num_classes=200, norm='bn'):
    if norm == 'gn':
        norm_layer = MyGroupNorm
...
if __name__ == "__main__":
    ...
    model = multi_resnet34_tiny(n_blocks=4, num_classes=200)
