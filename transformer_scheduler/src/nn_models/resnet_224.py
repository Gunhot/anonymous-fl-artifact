...
def multi_resnet18_224(n_blocks=4, num_classes=1000, norm='bn'):
    if norm == 'gn':
...
def multi_resnet34_kd(n_blocks=4, num_classes=1000, norm='bn'):
    if norm == 'gn':
        norm_layer = MyGroupNorm
...
if __name__ == "__main__":
    ...
    model = multi_resnet18_kd(n_blocks=2, num_classes=100)
