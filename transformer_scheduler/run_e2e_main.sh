...
COMMON_ARGS="--eval_mode main --dataset e2e --model gpt2s --batch_size 4 --local_epoch 1 --opt adam --lr 0.001 --lr_decay 0.999 --max_len 512 --use_pretrained 1 --seed 2 --noise_update 0"
